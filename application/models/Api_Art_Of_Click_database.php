...
Class Api_Art_Of_Click_Database extends CI_Model {
    ...
    public function addTolocalDb($sourceId, $offerTolocalAdd, $advertiserId) {
        ...
        foreach ($offerTolocalAdd as $offerTolocal) {
            ...
            if ($Addvals != '') {
                $Addvals = $Addvals . ',(' . $offerTolocal->affiseofferid . ',' . $offerTolocal->id . ',' . $sourceId . ',"' . urlencode($offerTolocal->name) . '","' . $offerTolocal->advertiser . '","' . urlencode($offerTolocal->trackingUrl) . '","' . urlencode($offerTolocal->previewUrl) . '","","","' . urlencode($offerTolocal->description) . '","","' . implode("|", $offerTolocal->countries) . '","","Art Of Click","","' . $offerTolocal->status . '","","","","' . $offerTolocal->payout . '","","","","' . ($offerTolocal->dailyCap) . '","","","","","' . implode("|", $offerTolocal->os) . '","","","","","","","","","","","","","","","",' . $offerTolocal->approved . ')';
            } else {
                $Addvals = $Addvals . '(' . $offerTolocal->affiseofferid . ',' . $offerTolocal->id . ',' . $sourceId . ',"' . urlencode($offerTolocal->name) . '","' . $offerTolocal->advertiser . '","' . urlencode($offerTolocal->trackingUrl) . '","' . urlencode($offerTolocal->previewUrl) . '","","","' . urlencode($offerTolocal->description) . '","","' . implode("|", $offerTolocal->countries) . '","","Art Of Click","","' . $offerTolocal->status . '","","","","' . $offerTolocal->payout . '","","","","' . ($offerTolocal->dailyCap) . '","","","","","' . implode("|", $offerTolocal->os) . '","","","","","","","","","","","","","","","",' . $offerTolocal->approved . ')';
            }
        }
